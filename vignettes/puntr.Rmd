...
# college_punts1 <- import_college_punts(2018:2019) # import (calls cfbscrapR behind the scenes)
# college_punts2 <- college_punts1 %>% college_to_pro() # rename columns to those used by nflfastR
# college_punts3 <- college_punts2 %>% calculate_all() # calculate as with NFL data
```
