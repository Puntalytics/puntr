...
### Completed seasons
For speed, we've already scraped (using [`nflfastR`](https://www.nflfastr.com/)) and saved punting data for the 1999-2020 seasons; our import function just grabs the data from [here](https://github.com/Puntalytics/puntr-data/tree/master/data). 
...
punts_raw <- import_punts(2019:2020) # fewer seasons is faster
