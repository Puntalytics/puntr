...
These dataframes - `punts`, `mini`, `miniY` and `miniG` - should serve as a good starting point for any custom analysis you'd like to do, be that using built-in `puntr` metrics, or your own. If a punter or punter-season you're looking for is missing, try playing around with the `threshold = ` parameter.
